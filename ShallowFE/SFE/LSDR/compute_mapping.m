...
%     end
    ...
    switch type
        case 'Isomap'         
			...
			if isempty(varargin), [mappedA, mapping] = isomap(A, no_dims, 3);
        ...
        case 'LPP'
            ...
            elseif length(varargin) == 1, [mappedA, mapping] = lpp(A, no_dims, varargin{1}, 1, eig_impl); 
                elseif length(varargin) == 2, [mappedA, mapping] = lpp(A, no_dims, varargin{1}, varargin{2}, eig_impl);
            else [mappedA, mapping] = lpp(A, no_dims, varargin{1}, varargin{2}, eig_impl,varargin{3}); end
            mapping.name = 'LPP';
